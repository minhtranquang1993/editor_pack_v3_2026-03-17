...
def main():
    ...
    try:
        ...
        from drive_media_tools import refresh_access_token, UPLOAD_API, DRIVE_API
        ...
        with open(encrypted, "rb") as f:
            files = {
                ...
                "file": (encrypted.name, f, "application/gzip"),
            }
            resp = _requests.post(
                UPLOAD_API,
                headers=headers,
        ...
        print(f"⚠️ Drive upload skipped — missing dependency: {e}")
        print(f"   File saved locally: {encrypted}")
    except FileNotFoundError as e:
        print(f"⚠️ Drive upload skipped — missing credentials: {e}")
        print(f"   File saved locally: {encrypted}")
