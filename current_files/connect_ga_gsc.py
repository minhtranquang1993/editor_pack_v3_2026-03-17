...
def main():
    ...
    ap.add_argument("--token", default="/root/.openclaw/workspace/credentials/ga_gsc_token.json")
    ap.add_argument("--port", type=int, default=8080)
    ap.add_argument("--ga", nargs="*", default=[])
    ap.add_argument("--gsc", nargs="*", default=[])
    ap.add_argument("--out", default="/root/.openclaw/workspace/memory/ga_gsc_connection_status.json")
    args = ap.parse_args()
